...
import com.programing.orderservice.dto.OrderLineItemsDto;
import com.programing.orderservice.dto.OrderRequest;
import com.programing.orderservice.model.Order;
import com.programing.orderservice.model.OrderLineItems;
...
public class OrderService {
    ...
    public void placeOrder(OrderRequest orderRequest) {
        ...
        if(allProductsInStock){
            ...
            List<InventoryResponse> result = Arrays.stream(inventoryResponseArray).filter(item -> !order.getOrderLineItemsList().contains(item)).collect(Collectors.toList());
